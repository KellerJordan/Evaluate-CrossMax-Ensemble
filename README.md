...
Presumably we get a higher accurcy (77%) for the CrossMax ensemble because we only use PGD whereas they use APGD-T attack,
which perhaps is able to somewhat compensate for the gradient masking effect.
